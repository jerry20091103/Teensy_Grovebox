...
AudioMixer4              mixerSWPeakI2sL; //xy=2860.9999923706055,881.4999923706055
AudioMixer4              mixerSWPeakI2sR; //xy=2867.9999923706055,1034.4999923706055
...
AudioOutputI2S           i2sOUT;         //xy=2905.9999923706055,959.4999923706055
AudioOutputUSB           usbOUT;         //xy=2921.9999923706055,1335.4999923706055
AudioAnalyzePeak         peakI2sL;       //xy=3033.9999923706055,880.4999923706055
AudioAnalyzePeak         peakI2sR;       //xy=3042.9999923706055,1035.4999923706055
...
AudioConnection          patchCord97(ampEnvelope0, 0, voiceSwitch0, 1);
AudioConnection          patchCord98(ampEnvelope0, ampEnvSample0);
AudioConnection          patchCord99(wavetable6, 0, voiceSwitch6, 0);
AudioConnection          patchCord100(ampEnvelope2, 0, voiceSwitch2, 1);
AudioConnection          patchCord101(ampEnvelope2, ampEnvSample2);
AudioConnection          patchCord102(wavetable2, 0, voiceSwitch2, 0);
AudioConnection          patchCord103(ampEnvelope3, 0, voiceSwitch3, 1);
AudioConnection          patchCord104(ampEnvelope3, ampEnvSample3);
AudioConnection          patchCord105(ampEnvelope5, 0, voiceSwitch5, 1);
AudioConnection          patchCord106(ampEnvelope5, ampEnvSample5);
AudioConnection          patchCord107(wavetable7, 0, voiceSwitch7, 0);
AudioConnection          patchCord108(wavetable3, 0, voiceSwitch3, 0);
AudioConnection          patchCord109(wavetable4, 0, voiceSwitch4, 0);
AudioConnection          patchCord110(wavetable1, 0, voiceSwitch1, 0);
AudioConnection          patchCord111(wavetable0, 0, voiceSwitch0, 0);
AudioConnection          patchCord112(wavetable5, 0, voiceSwitch5, 0);
AudioConnection          patchCord113(voiceSwitch6, 0, voiceMixer0_1, 2);
AudioConnection          patchCord114(voiceSwitch4, 0, voiceMixer0_1, 0);
AudioConnection          patchCord115(voiceSwitch7, 0, voiceMixer0_1, 3);
AudioConnection          patchCord116(voiceSwitch2, 0, voiceMixer0_0, 2);
AudioConnection          patchCord117(voiceSwitch1, 0, voiceMixer0_0, 1);
AudioConnection          patchCord118(voiceSwitch3, 0, voiceMixer0_0, 3);
AudioConnection          patchCord119(voiceSwitch5, 0, voiceMixer0_1, 1);
AudioConnection          patchCord120(voiceSwitch0, 0, voiceMixer0_0, 0);
AudioConnection          patchCord121(voiceMixer0_0, 0, voiceMixer1_0, 0);
AudioConnection          patchCord122(voiceMixer0_1, 0, voiceMixer1_0, 1);
AudioConnection          patchCord123(voiceMixer1_0, 0, freeverbMixerL, 0);
AudioConnection          patchCord124(voiceMixer1_0, 0, freeverbMixerR, 0);
AudioConnection          patchCord125(freeverbBiquadL, 0, freeverbMixerL, 1);
AudioConnection          patchCord126(freeverbBiquadR, 0, freeverbMixerR, 1);
AudioConnection          patchCord127(freeverbMixerL, ampInsOutL);
AudioConnection          patchCord128(freeverbMixerR, ampInsOutR);
AudioConnection          patchCord129(i2sIN, 0, ampI2sInL, 0);
AudioConnection          patchCord130(i2sIN, 0, mixerSWPeakLmInL, 1);
AudioConnection          patchCord131(i2sIN, 0, peakVelocity, 0);
AudioConnection          patchCord132(i2sIN, 1, ampI2sInR, 0);
AudioConnection          patchCord133(i2sIN, 1, mixerSWPeakLmInR, 1);
AudioConnection          patchCord134(usbIN, 0, ampUsbInL, 0);
AudioConnection          patchCord135(usbIN, 0, mixerSWPeakUsbInL, 1);
AudioConnection          patchCord136(usbIN, 1, ampUsbInR, 0);
AudioConnection          patchCord137(usbIN, 1, mixerSWPeakUsbInR, 1);
AudioConnection          patchCord138(ampI2sInR, 0, mixerSWPeakLmInR, 0);
AudioConnection          patchCord139(ampI2sInR, 0, mixerOutI2sR, 0);
AudioConnection          patchCord140(ampI2sInR, 0, mixerOutUsbR, 0);
AudioConnection          patchCord141(ampI2sInR, peakMixerLmR);
AudioConnection          patchCord142(ampI2sInL, 0, mixerSWPeakLmInL, 0);
AudioConnection          patchCord143(ampI2sInL, 0, mixerOutI2sL, 0);
AudioConnection          patchCord144(ampI2sInL, 0, mixerOutUsbL, 0);
AudioConnection          patchCord145(ampI2sInL, peakMixerLmL);
AudioConnection          patchCord146(ampUsbInR, 0, mixerSWPeakUsbInR, 0);
AudioConnection          patchCord147(ampUsbInR, 0, mixerOutI2sR, 1);
AudioConnection          patchCord148(ampUsbInR, 0, mixerOutUsbR, 1);
AudioConnection          patchCord149(ampUsbInR, peakMixerUsbR);
AudioConnection          patchCord150(ampUsbInL, 0, mixerSWPeakUsbInL, 0);
AudioConnection          patchCord151(ampUsbInL, 0, mixerOutI2sL, 1);
AudioConnection          patchCord152(ampUsbInL, 0, mixerOutUsbL, 1);
AudioConnection          patchCord153(ampUsbInL, peakMixerUsbL);
AudioConnection          patchCord154(ampInsOutL, peakMixerInsL);
AudioConnection          patchCord155(ampInsOutL, 0, mixerOutUsbL, 2);
AudioConnection          patchCord156(ampInsOutL, 0, mixerOutI2sL, 2);
AudioConnection          patchCord157(ampInsOutR, peakMixerInsR);
AudioConnection          patchCord158(ampInsOutR, 0, mixerOutUsbR, 2);
AudioConnection          patchCord159(ampInsOutR, 0, mixerOutI2sR, 2);
AudioConnection          patchCord160(mixerSWPeakUsbInL, peakUsbInL);
AudioConnection          patchCord161(mixerSWPeakUsbInR, peakUsbInR);
AudioConnection          patchCord162(mixerSWPeakLmInL, peakLmInL);
AudioConnection          patchCord163(mixerSWPeakLmInR, peakLmInR);
AudioConnection          patchCord164(mixerOutI2sL, ampMasterOutI2sL);
AudioConnection          patchCord165(mixerOutI2sL, 0, mixerSWPeakI2sL, 1);
AudioConnection          patchCord166(mixerOutI2sR, ampMasterOutI2sR);
AudioConnection          patchCord167(mixerOutI2sR, 0, mixerSWPeakI2sR, 1);
AudioConnection          patchCord168(mixerOutUsbR, ampMasterOutUsbR);
AudioConnection          patchCord169(mixerOutUsbR, 0, mixerSWPeakUsbR, 1);
AudioConnection          patchCord170(mixerOutUsbL, ampMasterOutUsbL);
AudioConnection          patchCord171(mixerOutUsbL, 0, mixerSWPeakUsbL, 1);
AudioConnection          patchCord172(ampMasterOutI2sL, 0, i2sOUT, 0);
AudioConnection          patchCord173(ampMasterOutI2sL, 0, mixerSWPeakI2sL, 0);
AudioConnection          patchCord174(ampMasterOutI2sR, 0, i2sOUT, 1);
AudioConnection          patchCord175(ampMasterOutI2sR, 0, mixerSWPeakI2sR, 0);
AudioConnection          patchCord176(ampMasterOutUsbL, 0, usbOUT, 0);
AudioConnection          patchCord177(ampMasterOutUsbL, 0, mixerSWPeakUsbL, 0);
AudioConnection          patchCord178(ampMasterOutUsbR, 0, usbOUT, 1);
AudioConnection          patchCord179(ampMasterOutUsbR, 0, mixerSWPeakUsbR, 0);
AudioConnection          patchCord180(mixerSWPeakI2sL, peakI2sL);
AudioConnection          patchCord181(mixerSWPeakI2sR, peakI2sR);
AudioConnection          patchCord182(mixerSWPeakUsbR, peakUsbR);
AudioConnection          patchCord183(mixerSWPeakUsbL, peakUsbL);
