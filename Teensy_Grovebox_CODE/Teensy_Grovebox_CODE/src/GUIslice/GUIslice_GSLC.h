...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG_BASE,E_PG_MIDI,E_PG_POPUP_POWER};
enum {E_DRAW_LINE1,E_DRAW_LINE2,E_ELEM_BOX10,E_ELEM_BTN5
      ...
      ,E_ELEM_MIDI_YELLOW_BOX4,E_ELEM_POWER_BTN_CALCEL
      ,E_ELEM_POWER_BTN_YES,E_ELEM_TEXT27,E_ELEM_TEXT28
      ,E_ELEM_TEXT_BATT,E_ELEM_TEXT_TITLE};
// Must use separate enum for fonts with MAX_FONT at end to use gslc_FontSet.
enum {E_ARIAL_10,E_ARIAL_12,E_ARIAL_12_BOLD,E_ARIAL_13,E_ARIAL_14
      ,E_AWESOMEF000_10,E_AWESOMEF200_14,MAX_FONT};
//<Enum !End!>
...
#define MAX_ELEM_PG_POPUP_POWER 6 // # Elems total on page
