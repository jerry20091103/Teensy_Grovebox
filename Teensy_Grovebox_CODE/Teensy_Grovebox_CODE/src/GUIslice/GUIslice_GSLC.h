...
enum {E_DRAW_LINE1,E_DRAW_LINE11,E_DRAW_LINE2,E_DRAW_LINE3,E_DRAW_LINE4
      ,E_DRAW_LINE7,E_DRAW_LINE8,E_ELEM_AUDIOIN_GAIN_RING
      ...
      ,E_ELEM_AUDIOIN_LM_VOL_TEXT,E_ELEM_AUDIOIN_MIC_BTN
      ,E_ELEM_AUDIOIN_PFL_BTN,E_ELEM_AUDIOIN_USB_L_BAR
      ,E_ELEM_AUDIOIN_USB_PEAK_L_BOX,E_ELEM_AUDIOIN_USB_PEAK_R_BOX
      ,E_ELEM_AUDIOIN_USB_R_BAR,E_ELEM_AUDIOIN_USB_VOL
      ,E_ELEM_AUDIOIN_USB_VOL_TEXT,E_ELEM_AUDIOOUT_ANALOG_BTN
      ,E_ELEM_AUDIOOUT_HP_VOL_RING,E_ELEM_AUDIOOUT_LINE_L_BAR
      ,E_ELEM_AUDIOOUT_LINE_PEAK_BAR,E_ELEM_AUDIOOUT_LINE_PEAK_L_BOX
      ,E_ELEM_AUDIOOUT_LINE_PEAK_R_BOX,E_ELEM_AUDIOOUT_LINE_R_BAR
      ,E_ELEM_AUDIOOUT_LINE_VOL,E_ELEM_AUDIOOUT_LINE_VOL_TEXT
      ,E_ELEM_AUDIOOUT_PP_BTN,E_ELEM_AUDIOOUT_PREFADER_BTN
      ,E_ELEM_AUDIOOUT_USB_BTN,E_ELEM_AUDIOOUT_USB_L_BAR
      ,E_ELEM_AUDIOOUT_USB_PEAK_BAR,E_ELEM_AUDIOOUT_USB_PEAK_L_BOX
      ,E_ELEM_AUDIOOUT_USB_PEAK_R_BOX,E_ELEM_AUDIOOUT_USB_R_BAR
      ,E_ELEM_AUDIOOUT_USB_VOL,E_ELEM_AUDIOOUT_USB_VOL_TEXT
      ,E_ELEM_BASE_BACK_BTN,E_ELEM_BOX10,E_ELEM_BOX24
      ,E_ELEM_DAMPING_RING,E_ELEM_HOME_DRUM_BTN,E_ELEM_HOME_FX_BTN
      ,E_ELEM_HOME_KEYBOARD_BTN,E_ELEM_HOME_MIDI_BTN
      ,E_ELEM_HOME_RECODER_BTN,E_ELEM_HOME_SETTINGS_BTN
      ,E_ELEM_HOME_SYNTH_BTN,E_ELEM_HOME_WAVE_BTN,E_ELEM_IMAGE13
      ,E_ELEM_IMAGE16,E_ELEM_IMAGE17,E_ELEM_IMAGE18
      ...
      ,E_ELEM_TEXT138,E_ELEM_TEXT27,E_ELEM_TEXT28,E_ELEM_TEXT29
      ...
      ,E_ELEM_TEXT_BATT,E_ELEM_TEXT_TITLE,E_ELEM_WAVE_COMP_RING
      ,E_ELEM_WAVE_OCTAVE_DEC_BTN,E_ELEM_WAVE_OCTAVE_INC_BTN
      ,E_ELEM_WAVE_OCTAVE_TEXT,E_ELEM_WAVE_PEAK_BOX
      ,E_ELEM_WAVE_ROOMSIZE_RING,E_ELEM_WAVE_SOUND_BTN
...
#define MAX_ELEM_PG_WAVE 28 // # Elems total on page
...
extern gslc_tsXRingGauge               m_sXRingGauge7;
extern gslc_tsXRingGauge               m_sXRingGauge8;
extern gslc_tsXRingGauge               m_sXRingGauge9;
...
extern gslc_tsElemRef* m_pElemWaveCompRing;
extern gslc_tsElemRef* m_pElemWaveDampingRing;
...
extern gslc_tsElemRef* m_pElemWaveRoomsizeRing;
